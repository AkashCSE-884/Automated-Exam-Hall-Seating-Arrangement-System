  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          <li><a href="teacher_home.php" class="nav-link scrollto active"><i class="bx bx-home"></i> <span>Home</span></a></li>
          <li><a href="ownExamList.php" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Exam Schedule</span></a></li>
          <li><a href="studentExamList.php" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Student Exam Schedule</span></a></li>
